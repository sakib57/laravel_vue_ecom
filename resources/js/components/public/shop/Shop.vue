<template>
     <div>
       <!-- product-grid-view content section start -->
		<section class="pages products-page section-padding-bottom" style="
    padding-top: 20px">
			<div class="container">
				<div class="row">
									...
									<div class="section-title clearfix">
										<ul>
											<li>
												<ul class="nav-view">
													<li class="active">
                                                        <a data-toggle="tab" href="#grid" class="active"> <i class="mdi mdi-view-module"></i> </a>
                                                    </li>
													<li>
                                                        <a data-toggle="tab" href="#list" class="active"> <i class="mdi mdi-view-list"></i> </a>
                                                    </li>
												</ul>
											</li>
										...
										<div class="col-xs-12 col-sm-6 col-md-4" v-for="product in products.data" :key="product.id">
											<div class="single-product">
												<div class="product-img">
													...
													<a href="#"><img width="180" height="200" :src="`/uploads/${product.image}`" :alt="product.name" /></a>
